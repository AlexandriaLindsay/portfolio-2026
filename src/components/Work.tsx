...
function ProjectCard({ project, onOpen }: { project: Project; onOpen: (p: Project) => void }) {
  return (
    <Reveal className={project.featured ? 'col-span-2 max-md:col-span-1' : ''}>
      <div
        className="group relative bg-white border border-accent/15 overflow-hidden transition-all duration-400 cursor-none hover:shadow-purple hover:-translate-y-1 hover:border-accent"
      ...
      >
        ...
        <div
          ...
          style={{ aspectRatio: project.featured ? '16/7' : '16/10' }}
        >
          <img
...
function ProjectModal({ project, onClose }: { project: Project; onClose: () => void }) {
  ...
  return (
    <div
      className="fixed inset-0 z-[3000] bg-fg/60 backdrop-blur-[8px] flex items-center justify-center p-6 animate-[fadeIn_.35s_ease_forwards]"
...
export default function Work() {
  ...
  return (
    <section id="work" className="py-[120px] bg-white">
      ...
      <Reveal delay={0.08}>
        <p className="flex items-center gap-2.5 font-serif text-[15px] text-muted mb-12 -mt-12">
